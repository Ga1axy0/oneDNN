...
void jit_rvv_eltwise_fwd_kernel_t::compute_vector(const eltwise_regs_t &r) {
#if defined(XBYAK_RISCV_V) && XBYAK_RISCV_V == 1
    jit_rvv_eltwise_emitter_t elt(this);
    switch (alg_) {
        case alg_kind::eltwise_abs: elt.abs(r, r.dst, r.src); break;
        case alg_kind::eltwise_clip: elt.clip(r, r.dst, r.src); break;
        case alg_kind::eltwise_hardsigmoid:
            elt.hardsigmoid(r, r.dst, r.src);
            break;
        case alg_kind::eltwise_hardswish: elt.hardswish(r, r.dst, r.src); break;
        case alg_kind::eltwise_linear: elt.linear(r, r.dst, r.src); break;
        case alg_kind::eltwise_relu: elt.relu(r, r.dst, r.src); break;
        case alg_kind::eltwise_sqrt: elt.sqrt(r, r.dst, r.src); break;
        case alg_kind::eltwise_square: elt.square(r, r.dst, r.src); break;
        case alg_kind::eltwise_round: elt.round(r, r.dst, r.src); break;
        case alg_kind::eltwise_tanh: elt.tanh(r, r.dst, r.src); break;
        case alg_kind::eltwise_logistic: elt.sigmoid(r, r.dst, r.src); break;
        case alg_kind::eltwise_swish: elt.swish(r, r.dst, r.src); break;
        case alg_kind::eltwise_elu: elt.elu(r, r.dst, r.src); break;
        case alg_kind::eltwise_gelu_tanh: elt.gelu_tanh(r, r.dst, r.src); break;
        case alg_kind::eltwise_gelu_erf: elt.gelu_erf(r, r.dst, r.src); break;
        case alg_kind::eltwise_exp: elt.exp(r, r.dst, r.src); break;
...
void jit_rvv_eltwise_fwd_kernel_t::generate() {
    ...
    const eltwise_regs_t regs {v_src, v_dst, v_tmp0, v_tmp1, v_tmp2, v_tmp3,
            f_alpha, f_beta, f_zero, f_one, f_tmp0, f_tmp1, t2, t3};
...
void jit_rvv_eltwise_fwd_kernel_f16_t::compute_vector(const eltwise_regs_t &r) {
#if defined(XBYAK_RISCV_V) && XBYAK_RISCV_V == 1
    jit_rvv_eltwise_emitter_t elt(this);
    switch (alg_) {
        case alg_kind::eltwise_abs: elt.abs(r, r.dst, r.src); break;
